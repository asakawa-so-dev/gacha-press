          ...
          return (
            <li key={product.id}>
              <Link
                ...
                className="flex items-center gap-3 rounded-lg bg-white p-3 border border-[var(--color-border)] hover:border-[var(--color-brand)] transition-all"
              >
                <span
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-sm font-medium ${rankStyle}`}
                >
                  {rank}
                </span>
