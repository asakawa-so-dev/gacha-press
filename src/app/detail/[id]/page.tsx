  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      <div className="mx-auto max-w-2xl px-4 py-4">
        <nav className="mb-4 flex items-center gap-2 text-sm text-[#9b9bab]">
        ...
        <ScrollReveal variant="scale">
          <article className="rounded-2xl bg-white shadow-sm overflow-hidden border border-[#e4e4ea]">
            <div className="relative aspect-square bg-[#f5f5f7]">
              ...
              />
              {product.is_new && (
                <span className="absolute left-3 top-3 rounded-md bg-[#3daae0] px-2 py-1 text-xs font-bold text-white">
                  NEW
                </span>
              )}
            </div>
            {product.image_url?.startsWith("http") && (
              <div className="flex items-center gap-1.5 border-t border-[#e4e4ea] bg-[#fafafa] px-4 py-2 text-xs text-[#9b9bab]">
            ...
            <div className="p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <span className="rounded-full bg-[#f5f5f7] px-3 py-1 text-xs font-medium text-[#5c5c6f]">
                  {product.genre}
                </span>
                <span className="rounded-full bg-[#f5f5f7] px-3 py-1 text-xs font-medium text-[#5c5c6f]">
                  {product.maker}
              ...
              {product.description && (
                <p className="mt-4 text-sm text-[#5c5c6f] leading-relaxed whitespace-pre-wrap">
                  {product.description}
                </p>
              )}
